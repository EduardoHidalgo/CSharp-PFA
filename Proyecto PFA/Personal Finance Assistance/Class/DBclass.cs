...
namespace Personal_Finance_Assistance
{
    public class DBclass : DB_Storer
    {
        ...
        public static void Create_Tipo_I()
        {
            ...
            T2_Expected_Date_Tipo_I = new DateTime[TABLE_TIPO_I_iterer];
        ...
        public static void Create_Tipo_E()
        {
            ...
            T3_Expected_Date_Tipo_E = new DateTime[TABLE_TIPO_E_iterer];
        ...
        public static void Create_Ingresos()
        {
            ...
            T4_Date_Ingreso = new DateTime[TABLE_INGRESOS_iterer];
            Disconnect();
        }
        public static void Create_Egresos()
        {
            ...
            T5_Date_Egreso = new DateTime[TABLE_EGRESOS_iterer];
            Disconnect();
        }
        ...
        public static void Create_Metas()
        {
            ...
            T7_Metas_Fecha_Limite = new DateTime[TABLE_METAS_iterer];
            Disconnect();
        }
        public static void Create_Evaluos()
        {
            Connect();
            Query = "SELECT COUNT(*) FROM " + TABLE_EVALUOS + " Where ID_User_Evaluo = " + ID_User;
            Command = new SQLiteCommand(Query, Connection);
            TABLE_EVALUOS_iterer = Convert.ToInt32(Command.ExecuteScalar());
            T8_ID_User_Evaluo = new int[3];
            T8_Fecha_Evaluo_Actual = new DateTime[3];
            T8_Total_Evaluos = new int[3];
            T8_Primer_Evaluo = new DateTime[3];
            Disconnect();
        }
        ...
        public static void Upload_Tipo_I()
        {
            ...
            while (Reader.Read())
            {
                ...
                T2_Expected_Date_Tipo_I[Counter] = Convert.ToDateTime(Reader[3]);
        ...
        public static void Upload_Tipo_E()
        {
            ...
            while (Reader.Read())
            {
                ...
                T3_Expected_Date_Tipo_E[Counter] = Convert.ToDateTime(Reader[3]);
        ...
        public static void Upload_Ingresos()
        {
            ...
            while (Reader.Read())
            {
                ...
                T4_Date_Ingreso[Counter] = Convert.ToDateTime(Reader[4]);
                Counter++;
            }
            Disconnect();
        }
        public static void Upload_Egresos()
        {
            ...
            while (Reader.Read())
            {
                ...
                T5_Date_Egreso[Counter] = Convert.ToDateTime(Reader[4]);
                Counter++;
            }
            Disconnect();
        }
        ...
        public static void Upload_Metas()
        {
            ...
            while (Reader.Read())
            {
                ...
                T7_Metas_Fecha_Limite[Counter] = Convert.ToDateTime(Reader[2]);
                Counter++;
            }
            Disconnect();
        }
        public static void Upload_Evaluos()
        {
            Connect();
            Query = "SELECT * FROM " + TABLE_EVALUOS + " WHERE ID_User_Evaluo = " + ID_User;
            Command = new SQLiteCommand(Query, Connection);
            Reader = Command.ExecuteReader();
            int Counter = 0;
            while (Reader.Read())
            {
                T8_ID_User_Evaluo[Counter] = Convert.ToInt32(Reader[0]);
                T8_Fecha_Evaluo_Actual[Counter] = Convert.ToDateTime(Reader[1]);
                T8_Total_Evaluos[Counter] = Convert.ToInt32(Reader[2]);
                T8_Primer_Evaluo[Counter] = Convert.ToDateTime(Reader[3]);
                Counter++;
            }
            Disconnect();
        }
        ...
        public static void Insert_Usuario(string user, string pass, string mail) //ID, User, Pass, Mail  //Inserta al usuario y crea sus configs
        {
            ...
            Query = "INSERT INTO " + TABLE_CONFIG + " (ID_User_Config, Lenguaje, Tema) VALUES (\'" + id + "\', 1, 2);";
            command = new SQLiteCommand(Query, Connection);
            try
            {
                command.ExecuteNonQuery();
            ...
            DateTime Date = DatetimeAlgorithms.GetEvaluoActual();

            Query = "INSERT INTO " + TABLE_EVALUOS + " (ID_User_Evaluo, Fecha_Evaluo_Actual, Total_Evaluos, Primer_Evaluo) VALUES (\'" + id + "\',\'" + Date + "\', 0,\'" + Date + "\');";
            command = new SQLiteCommand(Query, Connection);
            try
            {
                command.ExecuteNonQuery();
        ...
        public static void Delete_Usuario(int ID) //ID_User
        {
            ...
            using (Transaction = Connection.BeginTransaction())
            {
                using (Command = Connection.CreateCommand())
                {
                    ...
                    Command.ExecuteNonQuery();
                    Command.CommandText = "DELETE FROM " + TABLE_METAS + " WHERE ID_User_Metas = \'" + ID + "\'";  //Borra sus Metas.
                    Command.ExecuteNonQuery();
                    Command.CommandText = "DELETE FROM " + TABLE_EVALUOS + " WHERE ID_User_Evaluo = \'" + ID + "\'";  //Borra sus Evaluos.
                    Command.ExecuteNonQuery();
        ...
        public static void Modifier_Config(int Theme, int Leng)
        {
            Connect();
            using (Transaction = Connection.BeginTransaction())
            {
        ...
        public static void Modifier_Evaluo(DateTime Fecha_evaluo_Actual, int Total_Evaluos)
        {
            string Fecha = Convert.ToString(Fecha_evaluo_Actual);
            Connect();
            using (Transaction = Connection.BeginTransaction())
            {
                using (Command = Connection.CreateCommand())
                {
                    Command.Transaction = Transaction;
                    Command.CommandText = "UPDATE " + TABLE_EVALUOS + " SET Fecha_Evaluo_Actual = \'" + Fecha + "\' WHERE ID_User_Evaluo = " + ID_User;
                    Command.ExecuteNonQuery();
                    Command.CommandText = "UPDATE " + TABLE_EVALUOS + " SET Total_Evaluos = \'" + Total_Evaluos + "\' WHERE ID_User_Evaluo = " + ID_User;
                    Command.ExecuteNonQuery();
                }
                Transaction.Commit();
            }
